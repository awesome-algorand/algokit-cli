...
`algokit project` is a collection of commands and command groups useful for managing algokit compliant [project workspaces](/algokit/algokit-cli/docs/algokit/algokit-cli/init#workspaces-vs-standalone-projects).
...
- [link](/algokit/algokit-cli/docs/algokit/algokit-cli/project/link) - Powerful feature designed to streamline the integration between `frontend` and `contract` projects
- [list](/algokit/algokit-cli/docs/algokit/algokit-cli/project/list) - Enumerate all projects within an AlgoKit workspace.
- [run](/algokit/algokit-cli/docs/algokit/algokit-cli/project/run) - Define custom commands and manage their execution via `algokit` cli.
