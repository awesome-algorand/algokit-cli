...
AlgoKit provides a quick shortcut to [explore]() various Algorand networks using [lora](https://lora.algokit.io/) including [AlgoKit LocalNet](/algokit/algokit-cli/docs/algokit/algokit-cli/localnet)!

# LocalNet

The following three commands are all equivalent and will open lora pointing to the local [AlgoKit LocalNet](/algokit/algokit-cli/docs/algokit/algokit-cli/localnet) instance:
