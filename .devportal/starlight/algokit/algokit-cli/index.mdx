...
- [Bootstrap](/algokit/algokit-cli/docs/algokit/algokit-cli/project/bootstrap) - Bootstrap AlgoKit project dependencies
- [Compile](/algokit/algokit-cli/docs/algokit/algokit-cli/compile) - Compile Algorand Python code
- [Completions](/algokit/algokit-cli/docs/algokit/algokit-cli/completions) - Install shell completions for AlgoKit
- [Deploy](/algokit/algokit-cli/docs/algokit/algokit-cli/project/deploy) - Deploy your smart contracts effortlessly to various networks
- [Dispenser](/algokit/algokit-cli/docs/algokit/algokit-cli/dispenser) - Fund your TestNet account with ALGOs from the AlgoKit TestNet Dispenser
- [Doctor](/algokit/algokit-cli/docs/algokit/algokit-cli/doctor) - Check AlgoKit installation and dependencies
- [Explore](/algokit/algokit-cli/docs/algokit/algokit-cli/explore) - Explore Algorand Blockchains using lora
- [Generate](/algokit/algokit-cli/docs/algokit/algokit-cli/generate) - Generate code for an Algorand project
- [Goal](/algokit/algokit-cli/docs/algokit/algokit-cli/goal) - Run the Algorand goal CLI against the AlgoKit Sandbox
- [Init](/algokit/algokit-cli/docs/algokit/algokit-cli/init) - Quickly initialize new projects using official Algorand Templates or community provided templates
- [LocalNet](/algokit/algokit-cli/docs/algokit/algokit-cli/localnet) - Manage a locally sandboxed private Algorand network
- [Project](/algokit/algokit-cli/docs/algokit/algokit-cli/project) - Manage an AlgoKit project workspace on your file system
- [Tasks](/algokit/algokit-cli/docs/algokit/algokit-cli/tasks) - Perform a variety of useful operations on the Algorand blockchain
...
- `--skip-version-check` Skips updated AlgoKit version checking and prompting for that execution, this can also be disabled [permanently on a given machine](/algokit/algokit-cli/docs/references/algokit-cli/reference) with `algokit config version-prompt disable`.

See also the [AlgoKit CLI Reference](/algokit/algokit-cli/docs/references/algokit-cli/reference), which details every command, sub-command and option.
