...
Options:
  ...
  -m, --metadata FILE             Path to the ARC19 compliant asset metadata file to be uploaded to IPFS. If not
                                  ...
                                  {{ ARC3 }}#json-metadata-file-schema.
...
For in-depth details, visit the [mint section]() in the AlgoKit CLI reference documentation.
