...
Generate a vanity address with the keyword “ALGO” at the start of the address and store into a [wallet alias](/algokit/algokit-cli/docs/algokit/algokit-cli/tasks/wallet):
