...
See [Compile Python - Prerequisites]() and [Compile TypeScript - Prerequisites]() for details.
...
Algorand Python can be deployed to Algorand by using the PuyaPy optimising compiler, which takes Algorand Python and outputs [ARC-32](https://dev.algorand.co/arc-standards/arc-0032/) application spec files (among other formats) which, [when deployed](/algokit/algokit-cli/docs/algokit/algokit-cli/generate#typed-clients), will result in AVM bytecode execution semantics that match the given Python code.
...
For more complex examples, see the [examples](https://github.com/algorandfoundation/puya) in the [PuyaPy repo](https://github.com/algorandfoundation/puya).
...
Algorand TypeScript can be deployed to Algorand by using the PuyaTs optimising compiler, which takes Algorand TypeScript and outputs [ARC-32](https://dev.algorand.co/arc-standards/arc-0032/) application spec files (among other formats) which, [when deployed](/algokit/algokit-cli/docs/algokit/algokit-cli/generate#typed-clients), will result in AVM bytecode execution semantics that match the given TypeScript code.
